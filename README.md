...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xdx6fa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xdx6fa.containers.anotherwebservice.com/
...
```
git clone git@github.com:gdinsdale/container-xdx6fa.git
cd container-xdx6fa
```
...
```
docker attach container-xdx6fa
```
